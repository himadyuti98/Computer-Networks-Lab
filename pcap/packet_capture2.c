 ...
 /* If is Ethernet and IPv4, print packet contents */ 
  if (ntohs(arpheader->htype) == 1 && ntohs(arpheader->ptype) == 0x0800){ 
    ...
    if(strcmp(s2,"192.168.43.124.")==0 && (ntohs(arpheader->oper) == ARP_REPLY))
    {
      ...
      printf("injected\n");*/
      //pck=packet;
      //system("sudo arp -d 192.168.43.124");
      //perror("delete");
      strcpy(pck,packet);
      ...
      pck[38]=192;//0x00;//packet[28];
      pck[39]=168;//0x00;//packet[29];
      pck[40]=43;//0x00;//packet[30];
      pck[41]=1;//0x00;//packet[31];
     // sleep(5);
